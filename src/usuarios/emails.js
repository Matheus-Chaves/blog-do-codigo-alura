const nodemailer = require("nodemailer"); //documentação: https://nodemailer.com/about/
...
class EmailRedefinicaoSenha extends Email {
  constructor(usuario, token) {
    ...
    this.html = `<h1>Olá!</h1> Você pediu para redefinir sua senha. <p>Use o token a seguir para trocar a sua senha: ${token}</p>`;
  }
}
